...
const ROLES = [
  ...
  { value: 'Produksi', label: 'Staf Produksi / Penjahit' },
  { value: 'Driver', label: 'Driver / Logistik' },
  { value: 'Umum', label: 'Umum / Lainnya' },
];

const EMPTY_FORM = { name: '', phone: '', role: 'Purchasing', is_active: true };

export default function StaffModal({ open, onClose, onSubmit, editingStaff }: StaffModalProps) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
      ...
      <div className="relative w-full max-w-sm rounded-2xl bg-white shadow-xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 px-5 py-5">
          ...
          <label className="block">
            <span className="mb-1.5 block text-sm font-medium text-slate-700">Peran / Posisi</span>
            <select
              value={form.role}
